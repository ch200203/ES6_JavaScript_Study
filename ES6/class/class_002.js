...
console.log(myMultiplication.ret); // 10;


// [3] : 어떻게 클래스가 타입체크를 했을때 function으로 찍힐 수 있는 걸까?
...
// 4.결국 "프로토타입 객체" 쪽에 클래스내에 정의한 메서드들을 추가해놓는 것 이기 때문에,
//	 해당 클래스의 인스턴스(객체)가 생성되면 추가된 메서드를 자유롭게 이요할 수 있는 것이다. --> 프로토타입 이해가 필요!