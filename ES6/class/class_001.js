...
// 그럼에도 불구하고, 프로토타입 체인으로 객체지향 언어의 상속과 캡슐화(은닉화) 등의 OOP 문법을 구현할 수 있었다.
// 따라서, 자바스크립트 언어는 --> 클래스가 필요없는 프로토타입 기반의 OOP(객체지향) 언어
...
// 기존 프로토타입 기반의 OOP문법이 없어지고 새로운 Class 문법을 지원하는 것은 X
// 
...
p2.testHello();			// 안녕하세요~ 이순신(30) 회원님~ ^_^;;
