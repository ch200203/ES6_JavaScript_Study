...
// [1] : constructor  속성
// 이 속성은 함수(예 Animal)를 가르킨디다. ==> 참조 --> 즉, 참조를 값으로 가지는 송성
...
// 				  + constructor <-- 이게 생성자 함수를 가맄고 있으므로 이 값을 확인하면 됨
...
// testObj 인스턴스(객체)가 A로 생성된 것인지를 판별하는 방법?? --> instanceof 연산자 사용.
...
// 정리
// instanceof 연산자는 특정 객체가 그 객체와 연결된 즉, 프로토타입 체인에 연결 (포함) 되어 있는지 체크하는 방법 중 하나.
